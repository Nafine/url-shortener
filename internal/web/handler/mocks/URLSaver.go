...
func (_mock *MockURLSaver) SaveURL(s string, s1 string) error {
...
//   - s string
//   - s1 string
func (_e *MockURLSaver_Expecter) SaveURL(s interface{}, s1 interface{}) *MockURLSaver_SaveURL_Call {
	return &MockURLSaver_SaveURL_Call{Call: _e.mock.On("SaveURL", s, s1)}
}

func (_c *MockURLSaver_SaveURL_Call) Run(run func(s string, s1 string)) *MockURLSaver_SaveURL_Call {
...
func (_c *MockURLSaver_SaveURL_Call) RunAndReturn(run func(s string, s1 string) error) *MockURLSaver_SaveURL_Call {
	_c.Call.Return(run)
	return _c
}
